...
// This pins the pure decision core the browser rig drives end-to-end:
//   - the LOAD-BEARING invariant (AC2): a mint is registered SYNCHRONOUSLY in the
...
//   - both suppression windows (AC2): (a) IN-FLIGHT hold → the held second mint
...
//   - AC3: a NON-mint interact is not coalesced (passes straight through);
//   - AC1/AC5: coalescing OFF → both mints egress → two distinct ECIDs (the
...
describe("createCoalescingBroker — sync-register invariant (spec 012-02 AC2)", () => {
...
describe("createCoalescingBroker — window (a): in-flight hold (spec 012-02 AC2)", () => {
