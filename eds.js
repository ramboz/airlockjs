...
function createAirlock({
  ...
  const worker = connector === "pixel" ? new Worker(new URL("./pixel-chamber.worker.js", import.meta.url), { type: "module" }) : connector === "dom" ? new Worker(new URL("./dom-chamber.worker.js", import.meta.url), { type: "module" }) : connector === "helix-rum" ? new Worker(new URL("./helix-rum-chamber.worker.js", import.meta.url), { type: "module" }) : connector === "ga4-gtag" ? new Worker(new URL("./ga4-gtag-chamber.worker.js", import.meta.url), { type: "module" }) : new Worker(new URL("./chamber.worker.js", import.meta.url), { type: "module" });
  worker.postMessage(
    connector === "pixel" || connector === "dom" || connector === "helix-rum" || connector === "ga4-gtag" ? { type: "init", ...connectorConfig || {} } : { type: "init", trackers, workFactor, endpoints, ctx }
  );
  worker.onmessage = (e2) => {
    const data = e2.data;
...
function bootPixelConnector(vendor, opts = {}) {
  ...
  const resolvedExternalId = entry.advancedMatching ? externalId != null && externalId !== "" ? String(externalId) : externalIdCookie ? readCookieValue(typeof document !== "undefined" ? document.cookie : "", externalIdCookie) : void 0 : void 0;
...
var GA4_GTAG_MANIFEST_EVENTS = ["*"];
var HELIX_RUM_MANIFEST_EVENTS = ["top", "error", "cwv"];
var KNOWN_CONNECTOR_TYPES = ["ga4", "ga4-gtag", "pixel", "helix-rum", "alloy"];
