...
| [039-ga4-gtag-connector](039-ga4-gtag-connector/spec.md) | 039-03 — session-state reproduction + `_ga_<stream>` writer (closes OQ13-2) | RECONCILED (claude/spec-039-jigceremony…) |  |
