...
| [025-worker-dom-mirror](025-worker-dom-mirror/spec.md) | 025-03 — a real tag (Prism) through the mirror: `innerHTML` + a sanitized apply, INP-measured | **DONE** |  |
...
| [034-alloy-config-followups](034-alloy-config-followups/spec.md) | 034-01 — coarse-consent split: analytics flows when only personalization is denied | **DONE** |  |
| [034-alloy-config-followups](034-alloy-config-followups/spec.md) | 034-02 — multi-scope personalization: `decisionScopes` + N placements | **DONE** |  |
| [034-alloy-config-followups](034-alloy-config-followups/spec.md) | 034-03 — composite/exposure refinements: `accepts(name)` + a wired emit hook | **DONE** |  |
| [035-cookie-grant-wrapper](035-cookie-grant-wrapper/spec.md) | 035-01 — name-scope + name-validate the live alloy cookie grant | **DONE** |  |
...
| [042-get-critical-unload-dispatcher](042-get-critical-unload-dispatcher/spec.md) | 042-01 — GET-critical dispatcher + ga4-gtag unload flush | **DONE** |  |
...
- **31** shown-and-declined anomaly(ies) (a high-confidence richer skill was shown and not applied):
  ...
  - `036-real-site-validation-harness/slice-01-craft.md` — applied `none`; declined: pr-review, scout-pr-review
  ...
  - `041-ga4-gtag-boot/slice-03-craft.md` — applied `none`; declined: pr-review, scout-pr-review
