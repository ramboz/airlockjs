...
| [033-alloy-config-wiring](033-alloy-config-wiring/spec.md) | 033-03 — build: config-boot alloy (the personalization vertical) — decisions-as-data → `reserveSpace` | IN_PROGRESS (claude/mvp6-e4550f) |  |
...
- **83** pass(es) recorded `non-interactive` (declared no-orchestrator / CI).
