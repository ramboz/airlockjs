...
| [007-servo-oracle-ci](007-servo-oracle-ci/spec.md) | 007-01 — `ga4_mp_conformance` oracle component (hermetic + live complement) | READY_FOR_REVIEW (claude/airlock-servo-oracle…) |  |
| [007-servo-oracle-ci](007-servo-oracle-ci/spec.md) | 007-02 — `isolation_invariant` real-Worker assert (browser realm; run in CI by 07-05) | READY_FOR_REVIEW (claude/airlock-servo-oracle…) |  |
