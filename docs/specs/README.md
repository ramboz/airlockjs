...
| [020-alloy-xdm-governance](020-alloy-xdm-governance/spec.md) | 🔬 020-01 — alloy XDM-governance feasibility probe | IN_PROGRESS (main) |  |
...
- **53** pass(es) recorded `non-interactive` (declared no-orchestrator / CI).
